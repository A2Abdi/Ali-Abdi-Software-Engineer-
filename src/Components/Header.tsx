function Header(){
    return (
        ...
        <div className="content__top">
            ...
            <a className="force_underline wayne" href="https://wayne.edu/">WSU</a>
            <nav className="nav-container">
                ...
                <a className="nav-item" href="https://github.com/A2Abdi">Github</a>
                <a className="nav-item" href="https://devpost.com/alifeki45">Devpost</a>
            </nav>
        </div>
    </header>
    )
